-- Table: public.tbl_211_french_raw

-- DROP TABLE IF EXISTS public.tbl_211_french_raw;

CREATE TABLE IF NOT EXISTS public.tbl_211_french_raw
(
...
ALTER TABLE IF EXISTS public.tbl_211_french_raw
    OWNER to postgres;