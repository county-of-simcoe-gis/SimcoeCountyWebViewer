...
- Save MyMaps Graphics with a generated ID
- Import into a different computer or browser

![maps panel](./images/saveandimportwn.gif "My Maps")

<a name="right-click"></a>

## Share MyMaps

- Share your MyMaps markup with a URL

![maps panel](./images/sharewn.gif "My Maps")
