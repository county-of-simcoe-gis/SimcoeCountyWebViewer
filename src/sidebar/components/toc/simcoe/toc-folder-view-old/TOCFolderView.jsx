...
//         TOCHelpers.getGroupsGC(geoserverUrl, geoserverUrlType, false, (result) => {
//           const groupInfo = result;
//           this.buildDefaultGroup((defaultGroup) => {
//             let groups = [];
//             groups.push(defaultGroup);
...
//     // this.setState({ layers: newLayers, allLayers: allLayers, sortAlpha: sortAlpha }, () => {
...
//   render() {
//     return (
//       <div className={this.props.visible ? "" : "sc-hidden"}>
