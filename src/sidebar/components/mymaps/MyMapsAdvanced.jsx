...
class MyMapsAdvanced extends Component {
	...
	onShare = () => {
		...
		let currentUrl = `${window.location.href.split("?")[0]}?MY_MAPS_ID=${
			this.state.inputText
		}`;
		copy(currentUrl);
		helpers.showMessage(
			"MyMaps Share",
			"MyMaps link has been saved to clipboard.",
	...
	onSave = () => {
		...
		drawingHelpers.exportMyMaps((result) => {
			helpers.showMessage(
				"MyMaps Save",
				"MyMaps have been saved!  Your ID has been saved to clipboard.",
				helpers.messageColors.green,
				5000
			);
		...
		return (
			<div id="sc-mymaps-advanced">
				<Collapsible trigger="Advanced Options" open={this.state.open}>
					<div className="sc-mymaps-advanced-content">
						<div className="sc-mymaps-advanced-import-container">
							<label className="sc-mymaps-advanced-main-label">
								Import/Save
							</label>
							<div>
								<input
                ...
                /> */}
								<br />
								<button
									className="sc-button sc-mymaps-advanced-import-button"
						...
						<div className="sc-mymaps-advanced-edit-container">
							...
							>
								Edit Features
								<Switch
									className="sc-mymaps-advanced-switch"
									onChange={this.onSwitchChange}
									checked={this.state.editOn}
									height={20}
									width={48}
								/>
							</label>
							...
							<label style={{ marginRight: "15px" }}>
								<input
									className="sc-mymaps-advanced-edit-radio"
									type="radio"
									name="editOptions"
									value="vertices"
									defaultChecked={true}
						...
						<MyMapsFooter
							...
							onDeleteAllClick={this.props.onDeleteAllClick}
						/>
					</div>
				</Collapsible>
			</div>
