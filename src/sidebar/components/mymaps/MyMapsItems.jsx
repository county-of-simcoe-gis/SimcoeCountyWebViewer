  ...
  render() { 
    return ( 
      <div className="sc-container sc-mymaps-item-container">
        ...
        <div className={this.props.children.length === 0 ? "sc-mymaps-items-no-data" : "sc-hidden"}>There are currently no items to display. Please use the drawing tools above to create your own personal map item.</div>
        <div>
        {this.props.children}
        </div>
      </div>
