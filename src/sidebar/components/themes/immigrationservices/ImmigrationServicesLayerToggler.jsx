	...
	render() {
		return (
			<div>
				...
				>
					<div className="sc-immigration-layer-content">
	...
	return (
		<div className="sc-immigration-layer-header">
			<div className="sc-immigration-center">
				...
				<input
					className="sc-immigration-checkbox"
					type="checkbox"
				...
				<label className="sc-immigration-layer-count">
					{"(" + recordCount + ")"}
				</label>
				<img
					className="sc-immigration-information-icon"
					src={information}
					alt="show info"
