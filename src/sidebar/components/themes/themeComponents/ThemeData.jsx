...
class ThemeData extends Component {
  ...
  render() {
    if (this.props.config.excludeDataList) {
      return <div />;
    }
    return (
      <div className={this.props.className || "sc-theme-data-container"}>
        <div className="sc-title sc-underline">THEME DATA</div>
        <div className="sc-theme-data-filter-label">
          <label>
            <input type="checkbox" checked={this.state.onlyFeaturesWithinMap} style={{ verticalAlign: "middle" }} onChange={this.onCheckboxChange} />
