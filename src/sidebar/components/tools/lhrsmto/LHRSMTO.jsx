...
class LHRS extends Component {
  ...
  render() {
    return (
      <PanelComponent onClose={this.props.onClose} name={this.props.name} allowClick={true} hideHeader={this.props.hideHeader} type="tools">
