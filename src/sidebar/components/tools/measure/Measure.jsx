...
class Measure  extends Component {
    constructor(props){
      ...
      this.state = {
        ...
        unitType: "distance",
        unitList: [
          {name: "Kilometer",abbreviation: "km", type: "distance", convertFunction: (meters) => {return Math.round((meters / 1000) * 100) / 100}},
          {name: "Miles",abbreviation: "mi", type: "distance", convertFunction: (meters) => {return Math.round((meters / 1609.344) * 100) / 100}},
          {name: "Meter",abbreviation: "m", type: "distance", convertFunction: (meters) => {return Math.round((meters) * 100) / 100}},
          {name: "Feet",abbreviation: "ft", type: "distance", convertFunction: (meters) => {return Math.round((meters * 3.28084) * 100) / 100}},
          {name: "Yard",abbreviation: "yd", type: "distance", convertFunction: (meters) => {return Math.round((meters * 1.09361) * 100) / 100}},
          {name: "Inches",abbreviation: "in", type: "distance", convertFunction: (meters) => {return Math.round((meters * 39.3701) * 100) / 100}},
          {name: "Square Meter",abbreviation: "sq m", type: "area", convertFunction: (meters) => {return Math.round(meters * 100) / 100}},
          {name: "Hectare",abbreviation: "ha", type: "area", convertFunction: (meters) => {return Math.round((meters / 10000) * 100) / 100}},
          {name: "Acre",abbreviation: "ac", type: "area", convertFunction: (meters) => {return Math.round((meters / 4046.856) * 100) / 100}},
          {name: "Square Km",abbreviation: "sq km", type: "area", convertFunction: (meters) => {return Math.round((meters / 1000000) * 100) / 100}},
          {name: "Square Feet",abbreviation: "sq ft", type: "area", convertFunction: (meters) => {return Math.round((meters * 10.764) * 100) / 100}},
          {name: "Square Yard",abbreviation: "sq yard", type: "area", convertFunction: (meters) => {return Math.round((meters * 1.196) * 100) / 100}},
          {name: "Square Inches",abbreviation: "sq in", type: "area", convertFunction: (meters) => {return Math.round((meters * 1550.003) * 100) / 100}},
        ],
        unitMeters: -1,
          ...
          <div className="simcoe-measure-container">
            ...
            <div key={helpers.getUID()} className="sc-measure-button-bar">
              <div className={this.state.geometryType === "LineString" ? "sc-measure-button-container active" : "sc-measure-button-container"}>
                <button className="sc-measure-button" title="Draw a single line on the map" onClick={() => {this.onGeometryButtonClick("LineString", "distance")}}>
              ...
              <div className={this.state.geometryType === "Polygon" ? "sc-measure-button-container active" : "sc-measure-button-container"}>
                <button className="sc-measure-button" title="Draw a polygon on the map" onClick={() => {this.onGeometryButtonClick("Polygon", "area")}}>
              ...
              <div className={this.state.geometryType === "Circle" ? "sc-measure-button-container active" : "sc-measure-button-container"}>
                <button className="sc-measure-button" title="Draw a circle on the map" onClick={() => {this.onGeometryButtonClick("Circle", "area")}}>
              ...
              <div className={this.state.geometryType === "Rectangle" ? "sc-measure-button-container active" : "sc-measure-button-container"}>
                <button className="sc-measure-button" title="Draw a rectangle on the map" onClick={() => {this.onGeometryButtonClick("Rectangle", "area")}}>
              ...
              <div className={this.state.geometryType === "Clear" ? "sc-measure-button-container active" : "sc-measure-button-container"}>
                <button className="sc-measure-button" title="Clear Drawing" onClick={() => {this.onGeometryButtonClick("Clear")}}>
...
class MeasureResult extends Component {
  ...
  render() { 
    if (this.props.unitDetails.type !==  this.props.unitType)
      return null;
