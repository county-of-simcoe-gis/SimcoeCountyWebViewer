...
class BMap extends Component {
 ...
 render() {
   ...
   return (
            ...
            <div>           
				   {
				    (this.state.baseMapType == null )
                  ? null
				      :<BMapItem baseMapType={this.state.baseMapType}	/>
				   }
  		      </div>
         ...
         <div> 
             {
               ...
               (this.props.baseMapType.toLowerCase() == "basic")
               ? <BasicBasemapSwitcher></BasicBasemapSwitcher> 
