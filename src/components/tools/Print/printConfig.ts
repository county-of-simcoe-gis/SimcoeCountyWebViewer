/**
 * Print Configuration for MapFish Print Server
 * Ported from SimcoeCountyWebViewer config.json
 */
...
export interface PrintConfig {
  ...
  drawTypes: Record<string, string>;
  fonts: string[];
  overviewMapLayers: string[];
  basemapLayerNames: string[];
  mapTitle: string;
  termsOfUse: string;
}
...
export const printConfig: PrintConfig = {
  printSizes: [
    ...
    },
    {
      ...
      size: [570, 450],
      layout: "letter portrait overview",
      overview: true,
      type: "report",
    },
    {
