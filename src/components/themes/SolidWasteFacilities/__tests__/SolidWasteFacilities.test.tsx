...
import SolidWasteFacilities from "../SolidWasteFacilities";
...
describe("SolidWasteFacilities", () => {
  ...
  it("renders the panel with correct title", () => {
    render(<SolidWasteFacilities onClose={mockOnClose} />);

    expect(screen.getByText("Solid Waste Facilities")).toBeInTheDocument();
  });

  it("renders with custom name prop", () => {
    render(<SolidWasteFacilities onClose={mockOnClose} name="Waste Management" />);
