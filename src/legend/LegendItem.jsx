...
const LegendRow = ({legend}) => {
  return  <li className={cx(styles.listItem, "sc-noselect")} id={helpers.getUID()} style={{height:`${legend.height}px`}} title={legend.label}>
              <img style={{height:`${legend.height}px`, width:`${legend.width}px`}} src={`data:${legend.contentType};base64,${legend.imageData}`} alt="style" /><div className={styles.legendLabel} style={{height:`${legend.height}px`, width:`${220-legend.width}px`}}>{legend.label.trim()}</div>
          </li>;
}; 
