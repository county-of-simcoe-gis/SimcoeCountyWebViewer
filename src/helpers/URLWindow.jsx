...
class URLWindow extends Component {
	...
	render() {
		...
		if (this.props.hideScroll)
			hideScrollClassName = "sc-url-window-content-no-scroll";
		return (
			<div id="sc-url-window-container" className={className}>
				<div className="sc-url-window-header">
					...
					<div
						className="sc-url-window-header-popout-button"
						title="Open New Window"
					>
						<button
							className="sc-button sc-button-blue sc-url-window-header-button"
					...
					<div
						className="sc-url-window-header-close-button"
						title="Close Window"
					>
						<button
				...
				<div
					id="sc-url-window-content"
					className={
						this.props.showFooter
							? "sc-url-window-content with-footer " + hideScrollClassName
							: "sc-url-window-content " + hideScrollClassName
					}
				>
					<iframe
						id="sc-url-window-iframe"
						className="sc-url-window-iframe"
						src={this.props.url}
						frameBorder="0"
						title="Information"
					/>
				...
				<div
					className={
						this.props.showFooter ? "sc-url-window-footer" : "sc-hidden"
					}
				>
					...
					<button
						id="sc-url-window-dont-show-this-again"
						className="sc-button"
						onClick={this.onDontShowThisAgain}
					>
